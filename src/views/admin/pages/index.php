...
if (isset($_GET['error']))   { $msg_type = 'danger';  $msg_text = 'Gagal menyimpan page!'; }
...
<style>
.CodeMirror        { height:auto!important; min-height:450px; border-radius:.5rem; font-size:14px; }
                    ...
                    <div class="page-list-item p-3 mb-1 <?= $is_current ? 'active' : '' ?>">
                        <div class="d-flex align-items-start justify-content-between gap-2">
                            <div class="flex-grow-1 overflow-hidden">
                                <div class="fw-medium text-truncate small"><?= safe_html($p['title']) ?></div>
