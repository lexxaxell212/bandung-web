...
async function u() {
  try {
    ...
    const weatherDesc = d.weather[0].description.charAt(0).toUpperCase() + d.weather[0].description.slice(1);
    ...
    document.getElementById("w").innerHTML = `<div class="icon">${g(
      ...
      d.main.temp
    )}°C</div><div class="cond">${weatherDesc}</div><div class="stats"><div class="stat">${
      d.main.humidity
