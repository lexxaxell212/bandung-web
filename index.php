      ...
      <div class="highlight-event-container">
        ...
        <div class="highlight-event-content">
          ...
          <p class="highlight-event-subtitle">
            Pemerintah umumkan investasi Rp500 Triliun untuk infrastruktur
            digital nasional. 5G dan AI akan jadi tulang punggung ekonomi masa
            depan.
          </p>

          <button class="highlight-event-cta">Baca Lengkap →</button>
        </div>

        <!-- Image -->
        <div
          class="highlight-event-image"
          style="
            background-image: url(&quot;https://images.unsplash.com/photo-1689363302902-2c58330d6494?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80&quot;);
          "
        ></div>
      </div>
    </section>
        ...
        <div class="cards-container" id="cardsContainer">
          ...
          <div class="card">
            <div
              class="card-image"
              style="
                background-image: url(&quot;https://images.unsplash.com/photo-1677442136019-21780ecad995?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80&quot;);
              "
            ></div>
            <div class="card-content">
              ...
              <p class="card-excerpt">
                Artificial Intelligence bukan lagi masa depan, tapi realitas
                saat ini yang mengubah produktivitas dan kreativitas secara
                fundamental.
              </p>
          ...
          <div class="card">
            <div
              class="card-image"
              style="
                background-image: url(&quot;https://images.unsplash.com/photo-1559757148-5c350d0d3c56?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80&quot;);
              "
            ></div>
            <div class="card-content">
              <span class="card-category">Bisnis</span>
              <h3 class="card-title">
                Digital Marketing 2024: Strategi Terbukti
              </h3>
              <p class="card-excerpt">
                Tingkatkan konversi 300% dengan strategi marketing modern yang
                sudah teruji di lapangan oleh ribuan bisnis.
              </p>
              <button class="read-btn">Baca</button>
            </div>
          </div>
          ...
          <div class="card">
            ...
            <div class="card-content">
              ...
              <p class="card-excerpt">
                Desain minimalis bukan tren sementara, tapi filosofi yang
                menciptakan pengalaman user terbaik di era digital.
              </p>
              <button class="read-btn">Baca</button>
            </div>
          </div>
          ...
          <div class="card">
            ...
            <div class="card-content">
              ...
              <p class="card-excerpt">
                Tools yang sudah terbukti meningkatkan produktivitas tim remote
                secara signifikan dengan fitur canggih.
              </p>
              <button class="read-btn">Baca</button>
            </div>
          </div>
          ...
          <div class="card">
            <div
              class="card-image"
              style="
                background-image: url(&quot;https://images.unsplash.com/photo-1558618047-3c8c76ffe7dd?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80&quot;);
              "
            ></div>
            <div class="card-content">
              ...
              <p class="card-excerpt">
                Panduan lengkap membuat pitch deck dan strategi fundraising yang
                berhasil digunakan unicorn startups.
              </p>
              <button class="read-btn">Baca</button>
            </div>
          </div>
    ...
    <div class="event-news-section">
      <div class="event-news-cards-container">
        ...
        <article class="event-news-card">
          <div
            class="event-news-image"
            style="
              background-image: url(&quot;https://images.unsplash.com/photo-1689363302902-2c58330d6494?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80&quot;);
            "
          >
          ...
          <div class="event-news-content">
            <h2 class="event-news-title">
              Pemerintah Umumkan Investasi Rp500 Triliun Transformasi Digital
              Nasional
            </h2>
            <p class="event-news-excerpt">
              Menteri Kominfo mengungkapkan roadmap 2024-2028 dengan fokus
              infrastruktur 5G, AI, dan cloud computing untuk dorong ekonomi
              digital Indonesia.
            </p>
        ...
        <article class="event-news-card">
          <div
            class="event-news-image"
            style="
              background-image: url(&quot;https://images.unsplash.com/photo-1517336714731-489689fd1ca8?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80&quot;);
            "
          >
          ...
          <div class="event-news-content">
            ...
            <p class="event-news-excerpt">
              Pendanaan Seri D terbesar tahun ini diraih Gojek dengan valuasi
              mencapai $5 miliar dari investor top Amerika Serikat.
            </p>
            <button class="event-news-button">Baca Lengkap</button>
          </div>
        </article>
        ...
        <article class="event-news-card">
          ...
          <div class="event-news-content">
            ...
            <p class="event-news-excerpt">
              Gelaran terbesar teknologi tahunan di Jakarta Convention Center.
              Hadir 500+ startup dan 50+ investor global.
            </p>
            <button class="event-news-button">Baca Lengkap</button>
          </div>
        </article>
...
<?php /* Footer */ require_once 'includes/footer.php'; ?>
