...
<div class="card border-0 shadow-sm mb-4 py-5">
...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-header bg-white border-bottom py-3 px-4">
        <div class="d-flex align-items-center gap-2">
            ...
            <span class="fw-semibold">Informasi Site</span>
        </div>
    </div>
    <div class="card-body px-4 py-3">
        <form method="POST" action="/admin/setting">
            ...
            <hr class="my-4">
            <p class="fw-semibold mb-3">Kontak</p>
            <div class="row g-3">
                <div class="col-md-6">
            ...
            <hr class="my-4">
            <p class="fw-semibold mb-3">Social Media</p>
            <div class="row g-3">
                <div class="col-md-4">
            ...
            <hr class="my-4">
            <p class="fw-semibold mb-3">Analytics & Tracking</p>
            <div class="row g-3">
                <div class="col-md-6">
